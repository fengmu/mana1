	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage	: '/static/mana1/js/jquery.progressbar/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage	: {
								0:	'/static/mana1/js/jquery.progressbar/images/progressbg_red.gif',
								30: '/static/mana1/js/jquery.progressbar/images/progressbg_orange.gif',
								70: '/static/mana1/js/jquery.progressbar/images/progressbg_green.gif'
