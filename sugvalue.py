    ...
    if request.method=='POST':
        ...
        if ty=="sub": #非聚集
            ...
            if jlist['spcode']<>'' or jlist['spname']<>'' or jlist['mdcode']<>'' or jlist['mdname']<>'': #不全为空
                ...
                sqlstr= "select mdcode, mdname, spcode, spname, suggest, suggestcost  from dhalldata where assortment is not null and status < '5' and suggest > 0 and shelf > '-1' and dhtag='T' and delivery = 'T' limit 20000"
            ...
            if jlist['spcode']<>'' or jlist['spname']<>'' or jlist['mdcode']<>'' or jlist['mdname']<>'': #不全为空
                ...
                sqlstr="select mdcode, mdname,sum(suggest),sum(suggestcost)  from dhalldata where assortment is not null and status < '5' and suggest > 0 and shelf > '-1' and dhtag='T' and delivery = 'T' group by mdcode,mdname limit 20000"
